...
/* Could not find declaration for deprecated_apis */
...
int main(int argc, char *argv[])
{
	...
	const char *err_msg;
	assert(!parse_wireaddr("odpzvneidqdf5hdq.onion:49150", &addr, 1, false, &err_msg));
	assert(streq(err_msg, "v2 Tor onion services are deprecated"));

	assert(!parse_wireaddr("odpzvneidqdf5hdq.onion", &addr, 1, false, NULL));
	assert(streq(err_msg, "v2 Tor onion services are deprecated"));

	assert(wireaddr_from_hostname(tmpctx, "odpzvneidqdf5hdq.onion", 1, NULL, NULL, NULL) == 0);
