...
i.e.`3fyb44wdhnd2ghhl.onion` have been deprecated on the Tor network and are only handled
when the `allow-deprecated-apis` configuration option is set to `true`.
...
* Persistent version 3 .onion addresseses (v2 and v3).
